...
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER\
    , SHIFT_UP, SHIFT_DOWN, RSHIFT_UP, RSHIFT_DOWN, DASH_TIMER = range(10)
...
class DashState:
    ...
    def draw(boy):
        if boy.velocity == 1:
            boy.image.clip_draw(boy.frame * 100, 100, 100, 100, boy.x - 20, boy.y)
            boy.image.clip_draw(boy.frame * 100, 100, 100, 100, boy.x - 10, boy.y)
            boy.image.clip_draw(boy.frame * 100, 100, 100, 100, boy.x, boy.y)
        else:
            boy.image.clip_draw(boy.frame * 100, 0, 100, 100, boy.x + 20, boy.y)
            boy.image.clip_draw(boy.frame * 100, 0, 100, 100, boy.x + 10, boy.y)
            boy.image.clip_draw(boy.frame * 100, 0, 100, 100, boy.x, boy.y)
...
# fill here
    ...
    RunState:   {RIGHT_UP: IdleState, LEFT_UP: IdleState,
                 ...
                 RSHIFT_UP: RunState, RSHIFT_DOWN: DashState},
    SleepState: {LEFT_DOWN: RunState, RIGHT_DOWN: RunState,
                 LEFT_UP: RunState, RIGHT_UP: RunState,
                 SHIFT_UP: SleepState, SHIFT_DOWN: IdleState,
                 RSHIFT_UP: SleepState, RSHIFT_DOWN: IdleState},
