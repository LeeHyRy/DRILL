...
p1 = x1, y1 = random.randint(100, 500), random.randint(100, 300)
p2 = x2, y2 = random.randint(-400, -100), random.randint(100, 300)
p3 = x3, y3 = random.randint(-500, -100), random.randint(-300, -100)
p4 = x4, y4 = random.randint(200, 400), random.randint(-300, -100)
